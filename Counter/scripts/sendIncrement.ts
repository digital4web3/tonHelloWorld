...
import { TonClient, WalletContractV3R2, Address } from "@ton/ton";
...
export async function run() {
  ...
  const counterAddress = Address.parse("EQAaBa-Cq5kMGlGEHOh30OK6xiN_Z87gQSpedK4u8a1K3Dg_"); // replace with your address from step 8
